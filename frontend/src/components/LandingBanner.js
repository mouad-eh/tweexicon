    ...
    return (
        <Box sx={{
            ...
            <Box sx={{
                ...
                <Box>
                    <Button component={Link} to='/signup' variant='solid' sx={{
                        mr: 2,
                        px: 3,
                        py: 1,
                        fontSize: '0.9rem',
                    ...
                    <Button component={Link} to='/signin' variant='outlined' sx={{
                        px: 3,
                        py: 1,
                        fontSize: '0.9rem',
                        textTransform: 'capitalize',
            ...
            >
                <img src={bannerImg} alt="headerImg" style={{
                    width: "100%",
                }} />
            </Box>
        </Box>
