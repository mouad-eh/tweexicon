...
export default function OptionsBar({ setCategory, setPageData }) {
  ...
  return (
    ...
    >
      ...
      <AddPostModel open={newPostOpen} setOpen={setNewPostOpen} />
      <DeleteCatModel open={deleteCatOpen} setOpen={setDeleteCatOpen} setSearchCategory={setCategory} setPageData={setPageData} />
    </Sheet>
  );
}
