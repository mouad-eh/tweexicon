...
import {
  Box, Button, Modal, ModalClose, ModalDialog, Typography,
} from '@mui/joy';
...
export default function DeleteCatModel({
  open, setOpen, setSearchCategory, setPageData,
}) {
      ...
      >
        ...
        >
          ...
          <Box>
            ...
            <CustomAutoComplete
              placeholder="search..."
              options={isLoading ? [] : categories.filter((v, i) => v.name !== 'default')}
              sx={{ width: '100%' }}
              required
